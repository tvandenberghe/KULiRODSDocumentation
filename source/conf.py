...
project = 'KU Leuven RDM documentation'
copyright = '2022, KU Leuven ICTS FOZ-RDM'
author = 'KU Leuven ICTS FOZ-RDM'
...
#html_css_files = ['css/kuleuven.css']
